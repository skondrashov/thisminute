...
DOMAIN_PROMPTS = {
    ...
    "curious": {
        ...
        "examples_bad": '"Interesting news" (meaningless), "Human interest stories" (too vague), "Viral content" (too broad), "Miscellaneous curiosities" (catch-all bucket), "Good news roundup" (that\'s positive, not curious), "2026 Oscars" (mainstream entertainment, not curious), "Super Bowl LXII" (mainstream sports), "Grammy Awards 2026" (mainstream awards show)',
        "guidance": 'A curious situation is something that makes people say "wait, really?" or "you have to see this." Think viral stories, quirky science, unusual discoveries, local heroes doing remarkable things, animal stories, odd coincidences, record-breaking feats, and unexpected events. "Dog Elected Mayor of Small Town" qualifies. "Senate Passes Budget" does not. This is NOT the same as positive — a gripping true crime investigation or a bizarre natural disaster can be highly curious without being positive. And a routine charity donation is positive but not curious. Focus on stories with high engagement/shareability factor. NEVER create thematic buckets — each situation must be about ONE specific story or connected set of events.\n\nEXCLUSIONS — these belong in other domains, NOT curious:\n- Award ceremonies (Oscars, Grammys, Emmys, Golden Globes, etc.) → entertainment\n- Mainstream celebrity events (red carpets, premieres, tours) → entertainment\n- Sports records or championship results → sports\n- War, military operations, geopolitics → news/conflict\n- Stock market movements, earnings reports → business\nOnly include these if the story has a genuinely bizarre or unexpected angle (e.g., "Oscar Statue Found in Dumpster" is curious, "2026 Oscar Winners" is not).',
    },
    "science": {
